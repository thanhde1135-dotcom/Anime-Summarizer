...
# ====================== DÁN KEY OPENROUTER CỦA BẠN VÀO ĐÂY ======================
OPENROUTER_API_KEY = "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"   # ← Thay bằng key thật của bạn

# Model uncensored free (đã kiểm tra đúng tên)
...
if prompt := st.chat_input("Nhập tin nhắn..."):
    ...
    with st.chat_message("assistant"):
        ...
        if prompt.lower().startswith(("/ảnh", "/image", "/img")):
            ...
            if not img_prompt:
                reply = "Gõ thêm mô tả đi.\nVí dụ: `/ảnh cô gái anime khỏa thân`"
                st.markdown(reply)
                st.session_state.messages.append({"role": "assistant", "content": reply})
            else:
                with st.spinner("Đang tạo ảnh 18+..."):
                    ...
                    if img:
                        ...
                        st.error("Tạo ảnh thất bại, thử lại nhé.")
        else:
            # Chat uncensored
